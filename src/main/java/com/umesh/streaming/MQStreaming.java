...
import com.umesh.mq.CustomMQReceiver;
...
/**
 * Created by uchaudh on 12/28/2015.
 */
public class MQStreaming implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            JavaDStream<String> customReceiverStream = ssc.receiverStream(new CustomMQReceiver("host", 1414, "<qmanager>", "<channel>", "qname"));
